...
class MySuperSelector {
  constructor() {
    ...
    this.errorSelector = 'Selector parts should be arranged in the following order: element, id, class, attribute, pseudo-class, pseudo-element';
  }
  ...
  element(value) {
    ...
    if (this.idSelector || this.classSelector || this.attributeSelector) {
      throw new Error(this.errorSelector);
    }
